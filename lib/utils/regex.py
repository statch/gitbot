...
REPOSITORY_NAME_RE: re.Pattern = re.compile(r'(?P<slashname>(?P<owner>[A-Za-z\d](?:[A-Za-z\d]|-(?=[A-Za-z\d])){0,38})/(?P<name>[A-Za-z\d.](?:[A-Za-z\d.]|-(?=[A-Za-z\d.])){0,38}))/?(?P<branch>[A-Za-z\d.](?:[A-Za-z\d.]|-(?=[A-Za-z\d.])){0,38})?')
