...
class PyPIAPI:
    ...
    async def get_project_data(self, project: str) -> Optional[dict] | False:
    ...
    async def get_project_version_data(self, project: str, version: str) -> Optional[dict] | False:
    ...
    async def get_project_overall_downloads(self, project: str, mirrors: bool = False) -> Optional[dict] | False:
    ...
    async def get_project_recent_downloads(self, project: str) -> Optional[dict] | False:
