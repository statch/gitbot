...
class Help(commands.Cog):
    ...
    async def help_command(self, ctx: commands.Context) -> None:
        if ctx.invoked_subcommand is None:
            lines: list = [
                "In this section you'll find info and usage of my commands.",
    ...
    async def utlity_help(self, ctx: commands.Context) -> None:
        lines: list = [
            "These commands let you fetch various data related to Git and GitHub.",
    ...
    async def config_help(self, ctx: commands.Context) -> None:
        lines: list = [
            "**These commands affect the behavior of the Bot.**",
    ...
    async def info_help(self, ctx: commands.Context) -> None:
        lines: list = [
            "These commands have no ties to GitHub and focus on the Bot itself.",
    ...
    async def alias_command(self, ctx: commands.Context) -> None:
        if ctx.invoked_subcommand is None:
            lines: list = [
                "In this section you'll find shorthands of my commands",
                "\n**You can access specific parts by typing:**",
    ...
    async def github_aliases(self, ctx: commands.Context) -> None:
        lines: list = [
            "Some commands default to their `info` variant if it's omitted:",
