...
class Help(commands.Cog):
    ...
    @gitbot_group(name='help', aliases=['h'])
    ...
    @help_command.command(name='config')
    @commands.cooldown(15, 30, commands.BucketType.user)
    ...
    @alias_command_group.command(name='github')
    @commands.cooldown(15, 30, commands.BucketType.user)
    ...
    @alias_command_group.command(name='utility')
    @commands.cooldown(15, 30, commands.BucketType.user)
    ...
    @alias_command_group.command(name='config')
    @commands.cooldown(15, 30, commands.BucketType.user)
    ...
    @alias_command_group.command(name='info')
    @commands.cooldown(15, 30, commands.BucketType.user)
